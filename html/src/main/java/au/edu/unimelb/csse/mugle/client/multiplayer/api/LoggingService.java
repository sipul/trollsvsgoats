...
import au.edu.unimelb.csse.mugle.shared.multiplayer.api.PlayerNotFoundInGame;
...
public interface LoggingService extends RemoteService {
     ...
     * @throws PlayerNotFoundInGame
     */
    public void log(String instanceToken, GameState state,
            boolean hasLogMessages) throws InstanceTokenError,
